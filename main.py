...
if __name__ == "__main__":
    ...
    with open("mydata.json", "r") as f:
        ...
        schools_courted = {name: Courted(name, deepcopy(ordered_preferences), data["capacities"][name]) for name, ordered_preferences in data["schools"].items()}
    ...
    print(f"Schools sum capacity : {sum([capacity for name, capacity in data['capacities'].items()])}")
